...
.get(function(req,res){
	request.get('http://rahman.sisdis.ui.ac.id/tugas4/server/getImages', function(err, response, body){
		if (err)
...
.get(function(req,res){
	...
	request.get('http://rahman.sisdis.ui.ac.id/tugas4/server/getImage/'+req.params.name, function(err, response, body){
		var result = JSON.parse(body);
		if (!err) {
